...
export interface DocSectionIds {
  ...
  'create-synapse': 'code-organization-example-and-createsynapse-utility-usage' | 'connecting-synapse-to-each-other' | '-eventbus-pattern-advanced' | '-eventbus-pattern-code' | 'advantages-of-each-approach' | 'navigation'
