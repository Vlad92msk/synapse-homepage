...
// Generated at: 2025-06-18T17:16:39.562Z
// Master locale: en
...
export interface DocSectionIds {
  CHANGELOG: 'changelog' | '3013-2024-12-xx' | '3012-2024-12-27'
  README:
    | 'synapse-storage'
    | 'key-features'
    | 'author'
    | 'ps-not-recommended-for-production-use-yet-as-i-develop-this-in-my-free-time-the-library-works-in-general-but-i-can-provide-guarantees-only-after-full-integration-into-my-pet-project-social-network-this-wont-happen-before-changing-my-current-workplace-and-country-of-residence'
    | 'installation'
    | 'requirements'
    | 'documentation'
    | 'examples'
...
export type ValidSectionId<TDoc extends DocKey, TSection extends string> = TSection extends DocSectionIds[TDoc] ? TSection : never
...
export const AVAILABLE_DOC_KEYS: DocKey[] = [
  'CHANGELOG',
  'README',
  'additional',
  'api-client',
